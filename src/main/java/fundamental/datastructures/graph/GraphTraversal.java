...
import fundamental.datastructures.stackandqueues.Stack;
...
public class GraphTraversal {
    ...
    /**
     * The same aprroach as BFS solution. However, instead of a queue, we use a stack since it follows the
